...
interface ExpenseCategoryTableProps {
  columns: ColumnDef<ExpenseCategory>[]
  ...
  // Actions
  handleAdd: () => void
  handleEdit: (category: ExpenseCategory) => void
  setCategoryToDelete: (category: ExpenseCategory) => void
        ...
        <Card>
          <CardContent className="pt-6">
            <div className="flex flex-col items-center justify-center py-12 text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Gider kategorisi bulunamadı</h3>
              <p className="text-muted-foreground mb-4">Henüz gider kategorisi kaydı yok.</p>
